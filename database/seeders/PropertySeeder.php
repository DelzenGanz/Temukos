...
class PropertySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $property1->facilities()->attach(
            Facility::whereIn('name', ['AC', 'WiFi', 'Kamar mandi dalam', 'Security 24 jam'])->pluck('id')
        );
        ...
        // Attach facilities: WiFi, Dapur bersama, Parkir motor, Parkir mobil
        $property2->facilities()->attach(
            Facility::whereIn('name', ['WiFi', 'Dapur bersama', 'Parkir motor', 'Parkir mobil'])->pluck('id')
        );
    }
}
