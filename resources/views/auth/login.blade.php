...
<div class="min-h-[80vh] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Masuk ke Temukos</h1>
            <p class="text-sm text-gray-400 dark:text-gray-400 mt-1">Selamat datang kembali! Silakan masuk ke akunmu.</p>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-300">Ingat saya</span>
                    </label>
                </div>
