        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
                ...
                <div class="md:col-span-4 lg:col-span-4">
                    ...
                    <div class="space-y-4">
                        <a href="https://wa.me/6281234567890" target="_blank" class="flex items-center gap-4 p-4 rounded-2xl bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 hover:border-teal-500/50 transition-all group">
                            ...
                            <div>
                                ...
                                <p class="text-slate-200 font-medium">+62 812 3456 7890</p>
                            </div>
                        </a>
